...
def RangeNumberInput(context, range1 = 0, range2 = 0):
    while True:
...
# no error in this part 2017-2-28-10-39 by @Michael 3778
...
def TaskTwo(DataOne):
    ...
    TotalCost = 0.00
    if spareSeats > 0:
        morePeopleOrNot = input("there are "+str(spareSeats)+" seats left, do you want to add more people?(Y:yes, other:no)")

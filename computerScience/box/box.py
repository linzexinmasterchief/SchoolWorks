...
def gamePhysics():
    ...
    # camera_1_x = core.body.position[0] - (250)
    # camera_1_y = core.body.position[1] - (200)

    for i in core.bullet_list:
        i.__SetLinearVelocity((i.__GetLinearVelocity()[0], i.__GetLinearVelocity()[1] - 0.02))
...
def renderUI():
    # draw ui
    # draw jet bar
    # pygame.draw.rect(windowSurface, WHITE, (10, 10, core.jet_energy, 20))
    # draw height
    # heightFont = pygame.font.SysFont("consolas", 20)
    # heightLabel = heightFont.render(str(int(core.body.position[0])) + " " + str(int(core.body.position[1])), 1, (255,255,0))
